...
$(document).bind("pagecreate",function(evt) {
    ...
    if(evt.target.id=='page_start'){
    	$(function(){
    		GostopUI.page_start_onCreate(evt);
    	});
    }else if(evt.target.id=="page_main"){
    	$(function(){
    		GostopUI.page_main_onCreate(evt);
    	});
    }
});

$('#page_start').live('pageshow',GostopUI.page_start_onShow);
$('#page_start').live('pagehide', GostopUI.page_start_onHide);
$('#page_main').live('pageshow',GostopUI.page_main_onShow);
$('#page_main').live('pagehide', GostopUI.page_main_onHide);
